...
#if FEED_DIAL_SUPPORT && FEED_DIAL_PIN > -1
#define FEED_DIAL_ANALOG_INPUTS			1
#define FEED_DIAL_ANALOG_CHANNEL		FEED_DIAL_PIN
#define FEED_DIAL_COMMA					,
#else
#define FEED_DIAL_ANALOG_INPUTS			0
#define FEED_DIAL_ANALOG_CHANNEL
#define FEED_DIAL_COMMA
#endif
#define FEED_DIAL_ANALOG_INDEX			0

#if LASER_SUPPORT && LASER_TEMP_PIN > -1
#define LASER_TEMP_ANALOG_INPUTS        1
#define LASER_TEMP_ANALOG_CHANNEL       FEED_DIAL_COMMA LASER_TEMP_PIN
#define LASER_TEMP_COMMA			    ,
#else
#define LASER_TEMP_ANALOG_INPUTS        0
#define LASER_TEMP_ANALOG_CHANNEL
#define LASER_TEMP_COMMA				FEED_DIAL_COMMA
#endif
#define LASER_TEMP_ANALOG_INDEX         FEED_DIAL_ANALOG_INDEX + FEED_DIAL_ANALOG_INPUTS


#define ANALOG_INPUTS                   (FEED_DIAL_ANALOG_INPUTS + LASER_TEMP_ANALOG_INPUTS)
#define ANALOG_INPUT_CHANNELS           {FEED_DIAL_ANALOG_CHANNEL LASER_TEMP_ANALOG_CHANNEL}

...
public:
	...
	static TMC2208Stepper stepperX;
#elif TMC_X_TYPE == TMC_2209
	static TMC2209Stepper stepperX;
	...
	static TMC2208Stepper stepperY;
#elif TMC_Y_TYPE == TMC_2209
	static TMC2209Stepper stepperY;
	...
	static TMC2208Stepper stepperZ;
#elif TMC_Z_TYPE == TMC_2209
	static TMC2209Stepper stepperZ;
	...
	static TMC2208Stepper stepperA;
#elif TMC_A_TYPE == TMC_2209
	static TMC2209Stepper stepperA;
	...
	static TMC2208Stepper stepper2;
#elif TMC_2_TYPE == TMC_2209
	static TMC2209Stepper stepper2;
...
private:
	...
	static void configTMC2208(TMC2208Stepper* driver, uint8_t intpol, uint16_t rms, float hold_mult, uint8_t hold_delay, uint8_t tpower_down, uint8_t hstart, uint8_t hend, uint8_t toff, uint8_t tbl, uint8_t pwm_freq, uint16_t tpwmthrs, uint16_t microsteps, uint8_t pwm_grad, uint8_t pwm_ofs, uint8_t pwm_lim, uint8_t mode);
	static void configTMC2209(TMC2209Stepper* driver, uint8_t intpol, uint16_t rms, float hold_mult, uint8_t hold_delay, uint8_t tpower_down, uint8_t hstart, uint8_t hend, uint8_t toff, uint8_t tbl, uint8_t pwm_freq, uint16_t tpwmthrs, uint16_t microsteps, uint8_t pwm_grad, uint8_t pwm_ofs, uint8_t pwm_lim, uint8_t mode);

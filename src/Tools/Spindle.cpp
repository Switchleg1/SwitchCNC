...
*/
uint8_t Spindle::rpmMultiplier;
uint16_t Spindle::targetSpindleRpm;
int8_t Spindle::currentDirection;
uint8_t Spindle::currentSpindleSpeed;
uint16_t Spindle::currentSpindleRpm;
...
returning false.
*/
void Spindle::turnOff(uint8_t quiet) {
...
*/
void Spindle::turnOn(int8_t direction, uint16_t rpm, uint8_t quiet) {
...
void Spindle::setRpmMultiplier(uint8_t multiplier) {
